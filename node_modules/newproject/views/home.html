    ...
    <div class="panel panel-default" >
        ...
        <div class="panel-body">
            <ul class="spys" >
                ...
                <li class="spys li">
                    <div >
                        <img width="80" height="100"  src="/images/{{item.imgSrc}}"></div>
                    <div >
                        <a >
                            {{item.name}}</a> <strong style="color:red;" >￥
                            {{item.price}}</strong>
                    </div>
                    <div >
                        <a class="btn btn-success" style="width: 120px;"  href="/addToCart/{{item._id}}">加入购物车</a>
                    </div>
                </li>
                {% endfor %}
                </ul>
