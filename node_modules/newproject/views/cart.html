                ...
                <ul >
                    ...
                    <li>
                        <div class="li-checkbox">
                          <input data-id="{{item._id}}" data-index="{{loop.index}}"  data-price="{{item.cPrice}}" name="chkItem"  class="li-checkbox input" type="checkbox" />                        
                        </div>
                        <div class="li-img">
                          <a >
                            <img class="li-img a img" src="/images/{{item.cImgSrc}}"></a>
                        </div>
                        ...
                        <div class="li-quantity">
                          ...
                          <input id="Q{{loop.index}}" style="width: 40px;" type="text" value="
                            {{item.cQuantity}} ">                        
                          <a data-type='subtr' href="javascript:void(0);" class="btn btn-default btn-xs">-</a>
                        </div>
                        <div class="li-del" >
                          <a href="/delFromCart/{{item._id}}" class="btn btn-primary btn-xs">删除</a>
                        </div>
                    </li>
                    {% endfor %}
                </ul>
